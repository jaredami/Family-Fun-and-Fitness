    <footer>
      ...
      <div class="top-bar">
        ...
        <div class="tool-bar">
          <a class="tool-bar-link" href="#"><i class="fa fa-rss" aria-hidden="true"></i></a>
          <a class="tool-bar-link" href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
          <a class="tool-bar-link" href="https://www.facebook.com/FamilyFunFitness" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
          <a class="tool-bar-link" href="https://www.youtube.com/user/FamilyFunFitness" target="_blank"><i class="fa fa-youtube-play" aria-hidden="true"></i></a>
        </div>
      </div>
      </div>
    </footer>
